            ...
            <div className="p-6 space-y-8">
                ...
                <div className="flex items-center justify-between">
                    <h1 className="flex items-center text-3xl font-bold">
                        <Microwave className="w-9 h-9 mr-2" /> Bake Dashboard
                    </h1>
                    ...
                    <div className={cardClass}>
                        <div className="flex flex-wrap gap-4 justify-between items-center mb-5">
                            ...
                            >
                                ...
                                <select
                                    className={`selectClass w-full rounded-lg border border-gray-300 text-stone-600`}
                        ...
                        {renderChart(graphTypes.trend, data.trend, "total_qty")}
                    </div>
